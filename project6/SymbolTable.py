...
class SymbolTable:
    ...
    def __init__(self) -> None:
        ...
        and their pre-allocated RAM addresses, accord.ing to section 6.23 of the
        book.
        """

        self.table = {"SP": bin(0), "LCL": bin(1), "ARG": bin(2),
                      "THIS": bin(3), "THAT": bin(4), "SCREEN": bin(16384),
                      "KBD": bin(24576)}
        for i in range(16):
            string = "R" + str(i)
            self.table[string] = bin(i)
    ...
    def get_address(self, symbol: str) -> int:
        ...
        if self.contains(symbol):
            return int(self.table[symbol], 2)
